...
[CF 103119I - Nim Kẻ lừa đảo](https://codeforces.com/problemset/problem/103119/I) 
...
Các phương trình hàm ở phần (b) được sử dụng lặp đi lặp lại:$$\tau\!\left(\frac{x}{2}\right)=\frac{x}{2}+\frac12\tau(x),
\qquad
