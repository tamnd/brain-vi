...
Đối với mỗi mức tối thiểu khả thi$a$, định nghĩa$$B_a = \{ \{a\} \cup X : X \subseteq \{a+1,\dots,a+m-1\},\ |X|=3 \}.$$Mọi tổ hợp 4 được chấp nhận đều thuộc về đúng một$B_a$, cụ thể là$a=c_1$, Và$B_a$không trống chính xác khi$a+m-1 \le n-1$, tức là$0 \le a \le n-m$. 
