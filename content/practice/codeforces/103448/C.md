...
Ví dụ, nếu$n = 3$, mảng là$[0,1,2,3,4,5,6,7]$. Một vòng chia đôi nó thành 4 phần tử, tiếp theo là 2, sau đó là 1. Ngay cả ở đây, cấu trúc gợi ý về sự phân tách nhị phân thay vì tính toán vũ phu. 
...
Cách tiếp cận bạo lực mô phỏng từng vòng theo đúng nghĩa đen: xây dựng mảng, áp dụng thao tác cho từng cặp liền kề và lặp lại. Mỗi vòng xử lý một mảng thu nhỏ, do đó tổng công việc là$2^n + 2^{n-1} + \dots$, vẫn bị chi phối bởi$2^n$. Điều này ngay lập tức trở nên không thể ngay cả đối với$n = 25$, huống hồ là$10^5$. 
...
Điều này cho thấy cách XOR truyền tính chẵn lẻ thành ý nghĩa bit cao hơn. 
