...
2. Với mỗi căng tin i từ 2 đến n, hãy tính điểm gần nhất của nó trên hình chữ nhật. Chúng tôi thực hiện điều này bằng cách kẹp tọa độ x của nó vào [X1, X2]. Nếu x nhỏ hơn X1 thì sử dụng X1; nếu lớn hơn X2 thì dùng X2; nếu không thì chúng ta giữ x không thay đổi. Logic tương tự áp dụng cho y với [Y1, Y2]. Bước này xây dựng điểm khả thi về mặt hình học gần nhất trên hình chữ nhật với căng tin đã cho. 
...
| --- | --- | --- | 
| điểm duy nhất bên ngoài | 1 | tính đúng đắn của trường hợp cơ sở | 
| sự thống trị theo chiều ngang/dọc | 2 | hành vi kẹp đúng | 
...
Thuật toán xử lý việc này một cách chính xác vì cả hai tọa độ đều được kẹp độc lập, tạo ra điểm gần nhất thực sự (0,0). Khoảng cách bình phương được tính toán sẽ trở thành (−3)^2 + (−3)^2 = 18, khớp với mức tối thiểu thực của Euclide trên hình chữ nhật.
