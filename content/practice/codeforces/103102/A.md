---
title: "CF 103102A - Nhà khảo cổ học"
...
[CF 103102A - Các nhà khảo cổ học](https://codeforces.com/problemset/problem/103102/A) 
...
Đối với không bội số của$m$, tức là$t\in{1,\dots,m-1}$, chúng tôi có$q^{jm+t}=q^t$từ$q^m=1$. Do đó mỗi yếu tố như vậy chỉ phụ thuộc vào$t$và không bật$j$:$\frac{1-q^{n-k+jm+t}}{1-q^{jm+t}}=\frac{1-q^{(a-b)m+(r-s)+t}}{1-q^t}.$Như vậy tất cả các yếu tố không đa bội chỉ phụ thuộc vào$(r,s)$và xảy ra với bội số$b$khối đầy đủ cộng với khối độ dài còn lại được xác định bởi$s$; sản phẩm của họ chính xác là$\binom{r}{s}_q$, vì nó là sản phẩm tương tự như đối với$\binom{r}{s}_q$sau khi hủy toàn bộ$m$-sự lặp lại định kỳ. 
