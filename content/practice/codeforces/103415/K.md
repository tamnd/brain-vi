---
title: "CF 103415K - Đêm Pháp Sư"
description: "Giả sử $sigma$ và $tau$ là hai phép biến đổi trong hoán vị của ${1,2,dots,n}$ được đưa ra bởi các chuyển vị liền kề trên các lớp chẵn lẻ rời rạc, trong khung TAOCP σ-τ tiêu chuẩn, sao cho mỗi bước của bước đi σ-τ đều áp dụng $sigma$ hoặc $tau$ và mỗi ứng dụng sẽ thay đổi…"
...
[CF 103415K - Đêm pháp sư](https://codeforces.com/problemset/problem/103415/K) 
...
Mỗi σ-bước hoặc τ-bước trong$C$là sự hoán đổi vị trí liền kề. Khi nâng lên$S_6$, sự hoán đổi liền kề tương tự tác động lên các ký hiệu được gắn nhãn mà không có sự mơ hồ, vì hai ký hiệu giống hệt nhau trước đây giờ đây đã khác biệt. Do đó mọi cạnh trong$C$nâng lên cạnh σ hoặc τ được xác định rõ ràng trong biểu đồ hoán vị của$S_6$. 

Việc nâng lên tạo ra sự kết hợp rời rạc của các chu kỳ vì việc lựa chọn xem bản sao thứ nhất hay thứ hai của ký hiệu trùng lặp có được theo dõi hay không vẫn bất biến dọc theo mỗi lần di chuyển được nâng lên. Hai thành phần được nâng lên này tương ứng với hai thứ tự tương đối có thể có của các ký hiệu$1$Và$2$và không có thao tác σ hoặc τ nào thay đổi thứ tự đó trừ khi nó hoán đổi trực tiếp hai bản sao phân biệt, điều này không bao giờ xảy ra trong hình ảnh nâng lên của$C$bởi vì$C$chứa các ký hiệu giống hệt nhau ở các vị trí đó. 
...
Vì chu trình σ-τ ban đầu$C$truy cập vào mọi sắp xếp nhiều tập hợp, nó phải chứa ít nhất một mẫu kề trong đó hai bản sao phân biệt xuất hiện ở các vị trí liền kề. Tại thời điểm đó, việc chèn trao đổi giữa các bản sao sẽ tạo ra một cạnh cầu nối giữa hai chu kỳ được dỡ bỏ. 
