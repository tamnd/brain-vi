...
[CF 104015I - Tranh cây](https://codeforces.com/problemset/problem/104015/I) 
...
Các mục$2,1,1,2$vì$x_5,y_5,z_5$phát sinh từ các ràng buộc hậu tố ngày càng chặt chẽ hơn. Tại$x_5$, vẫn còn hai lớp tiếp tục riêng biệt vì hai bối cảnh hậu tố không tương đương vẫn cho phép hoàn thành. Tại$y_5$Và$z_5$, mỗi phép gán một phần sẽ xác định một hành vi tiếp tục duy nhất, do đó mỗi hành vi đóng góp một nút ZDD còn tồn tại cho mỗi lớp nhất quán. Giá trị cuối cùng$2$Tại$z_5$phản ánh rằng vẫn còn hai mẫu nhất quán cuối cùng riêng biệt cho các lần hoàn thành kết thúc bằng$z$, được phân biệt bằng việc ràng buộc cuối cùng được thỏa mãn một cách duy nhất hay bởi nhiều từ nhất quán với từ điển. 
