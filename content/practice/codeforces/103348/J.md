---
title: "CF 103348J - Rosencrantz và Guildenstern"
...
[CF 103348J - Rosencrantz và Guildenstern](https://codeforces.com/problemset/problem/103348/J) 
...
Ràng buộc$x_1 + x_2 + x_3 < m-4$xác định một lát cắt lồi của mạng thành phần này được đóng trong cùng một chuyển động chuyển đơn vị bất cứ khi nào chúng hợp pháp, vì việc chuyển một đơn vị giữa các tọa độ liền kề sẽ bảo toàn tất cả các giới hạn tổng một phần và chỉ thay đổi một bất đẳng thức cục bộ bằng cách$\pm 1$không vi phạm tính tích cực. Do đó, việc xây dựng mã Gray đệ quy có thể bị hạn chế ở tiểu vùng này mà không phá vỡ kết nối hoặc cấu trúc chuyển giao đơn vị, bởi vì mỗi trạng thái bị hạn chế vẫn thừa nhận một trạng thái tiền thân và kế thừa hợp pháp theo thứ tự đệ quy ngoại trừ tại các điểm cuối. 

Thứ tự kết quả sẽ truy cập vào mọi thành phần được chấp nhận chính xác một lần và thay đổi chính xác một cặp liền kề ở mỗi bước. Dịch ngược qua$p_i = x_i + 1$và sau đó đến$(c_1,c_2,c_3,c_4)$bảo toàn tính chất là mỗi bước thay đổi chính xác một$c_j$qua$\pm 1$. 
