---
title: "CF 104288C - Phân chia công bằng"
description: "Đặt $f^{D}(x1,dots,xn)=overline{f(overline{x1},dots,overline{xn})}$ và $f^{R}(x1,dots,xn)=f(xn,dots,x1)$. Việc kết hợp mang lại $$f^{DR}(x)=overline{f(overline{xn},dots,overline{x1})},qquad f^{RD}(x)=overline{f(overline{xn},dots,overline{x1})},$$ vì vậy $f^{DR}=f^{RD}$ theo sau…"
...
[CF 104288C - Phân chia công bằng](https://codeforces.com/problemset/problem/104288/C) 
