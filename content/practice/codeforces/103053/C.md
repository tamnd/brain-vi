---
title: "CF 103053C - Quạt du hành thời gian"
description: "Giả sử hình xuyến $2 nhân 2 nhân 3$ là tích Descartes $C2 nhân C2 nhân C3,$ sao cho các phần tử của nó là bộ ba $(i,j,k)$ với $i trong {0,1}$, $j trong {0,1}$, $k trong {0,1,2}$ và phép cộng được thực hiện theo modulo $2,2,3$ trong các tọa độ tương ứng."
...
[CF 103053C - Quạt du hành thời gian](https://codeforces.com/problemset/problem/103053/C) 
