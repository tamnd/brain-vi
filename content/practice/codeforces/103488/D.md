...
[CF 103488D - Chuỗi bị bệnh](https://codeforces.com/problemset/problem/103488/D) 
...
=
\left(\prod_{u=1}^{m}(1-q^u)\right)^L.$$Yếu tố với$u=m$là$1-q^m = 0$, do đó mỗi khối đầy đủ đóng góp một hệ số triệt tiêu. Trong tỉ số đa thức, các thừa số này xuất hiện với bội số giống nhau ở cả tử số và mẫu số, vì mỗi thừa số$N,n_1,\dots,n_t$chứa chính xác$A$khối hoàn chỉnh có kích thước$m$. Tất cả các hệ số 0 như vậy đều bị triệt tiêu theo thương số trong chuyên môn hóa chu trình$q^m=1$, chỉ để lại phần đóng góp giảm đi từ các phần dư khác không$1,\dots,m-1$cùng với khối cuối cùng chưa hoàn thiện. 
