...
[CF 104012K - Hình chữ K](https://codeforces.com/problemset/problem/104012/K) 
...
Bài tập 225 xây dựng một ZDD có đường đi mã hóa tất cả các đường đi đơn giản giữa hai đỉnh cố định$s$Và$t$. Việc xây dựng tiến hành bằng cách tìm kiếm có kiểm soát trên các tập hợp cạnh một phần: mỗi nút ZDD biểu thị trạng thái của đường dẫn một phần và mỗi quyết định tương ứng với việc bao gồm hoặc loại trừ một cạnh ứng cử viên, trong khi duy trì bất biến rằng các cạnh được chọn tạo thành một đường dẫn đơn giản từ điểm cuối hiện tại đến đích mà không lặp lại các đỉnh. 
