---
title: "CF 103931H - Tranh gia truyền"
...
[CF 103931H - Tranh gia truyền](https://codeforces.com/problemset/problem/103931/H) 
...
Như vậy, liền sau là từ gồm 13 dấu chấm, theo sau là một dấu gạch ngang:$$\underbrace{\cdot\cdots\cdots}_{13}\ -.$$### Ghi chú 

Cấu trúc là khối Fibonacci Mã màu xám ngụy trang: Từ trọng lượng Morse$n$tương ứng với các ô có chiều dài-$n$phân đoạn theo kích thước gạch$1$Và$2$và đệ quy phân chia theo ô cuối cùng. Sự đảo ngược trong khối thứ hai là cơ chế tiêu chuẩn đảm bảo sự thay đổi một bit (ở đây là thay thế cục bộ) khi nối.
