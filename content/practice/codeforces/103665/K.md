...
Nhiệm vụ là chọn một tập hợp con các xét nghiệm đảm bảo nhận dạng chính xác cho mọi bệnh thực sự có thể xảy ra đồng thời tôn trọng giới hạn sống sót. 
...
Tính đúng đắn phụ thuộc vào cấu trúc đơn điệu: như$X$tăng lên, có nhiều xét nghiệm hơn và`best[d]`chỉ có thể giảm chứ không bao giờ tăng. Điều này đảm bảo rằng chúng ta chỉ hướng tới các giải pháp tốt hơn hoặc tương đương trong khi quét. 
...
| Không gian |$O(n)$| lưu trữ các xét nghiệm và trạng thái của từng bệnh | 
