---
title: "CF 104595B - Người tung hứng cưa xích duyên dáng"
description: "Chúng tôi được cung cấp hai loại vật phẩm, cưa máy màu đỏ và cưa máy màu xanh, và chúng tôi muốn phân phối tất cả chúng cho một số người tung hứng."
...
[CF 104595B - Người tung hứng cưa xích duyên dáng](https://codeforces.com/problemset/problem/104595/B) 
...
Chúng tôi được cung cấp hai loại vật phẩm, cưa máy màu đỏ và cưa máy màu xanh, và chúng tôi muốn phân phối tất cả chúng cho một số người tung hứng. Mỗi người tung hứng nhận được một cặp số nguyên không âm mô tả số lượng cưa máy màu đỏ và màu xanh mà họ xử lý, và mỗi chiếc cưa máy phải được gán cho chính xác một người tung hứng. 
...
Một cách giải thích vũ phu sẽ cố gắng phân vùng$R$Và$B$vào trong$k$cặp riêng biệt$(r_i, b_i)$như vậy$\sum r_i = R$Và$\sum b_i = B$. Điều này trở thành một vấn đề phân vùng số nguyên bị ràng buộc với ràng buộc về tính khác biệt trên các cặp có thứ tự. Số cách chia$R$vào trong$k$phần không âm đã có rồi$\binom{R+k-1}{k-1}$, và tương tự cho$B$, vì vậy lặp đi lặp lại tất cả$k$và việc kiểm tra tính khả thi sẽ dẫn tới sự bùng nổ tổ hợp. 
...
3. Theo thứ tự này, tổng số màu đỏ tối thiểu có thể có cho$k$số nguyên không âm phân biệt là$$0 + 1 + 2 + \dots + (k-1) = \frac{k(k-1)}{2}$$Nếu điều này vượt quá$R$, sau đó$k$người tung hứng không thể được hình thành. 
...
6. Vì vậy$k$khả thi khi và chỉ khi$$\frac{k(k-1)}{2} \le R \quad \text{and} \quad \frac{k(k-1)}{2} \le B$$7. Tính số lớn nhất như vậy$k$trực tiếp bằng cách tăng cho đến khi điều kiện không thành công. 
...
Case #1: 1
Case #2: 3
```Trường hợp thứ hai cho thấy tính khả thi chỉ phụ thuộc vào việc liệu tăng trưởng tam giác có phù hợp với cả hai ngân sách hay không. 
...
Một trường hợp mất cân bằng nặng nề như$R = 10, B = 0$cho thấy màu xanh lam không hạn chế màu đỏ ngoài ranh giới tam giác chung; hệ số giới hạn trở thành tọa độ nhỏ hơn. 
