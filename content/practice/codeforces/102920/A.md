...
[CF 102920A - Xe tự lái](https://codeforces.com/problemset/problem/102920/A) 
...
Việc khởi tạo được sửa đổi thay thế yêu cầu rằng tất cả các phần ngoại trừ phần đầu tiên có thể ít nhất$1$bằng cách cho phép các phần trống ngay từ đầu. Cấu hình khởi đầu chính xác cho các phân vùng của$n$vào nhiều nhất$m$các phần là phần tử tối đa theo thứ tự từ điển trong số tất cả các phần giảm dần yếu$m$-tuples tổng hợp để$n$, cụ thể là một phần bằng$n$theo sau là số không. 
