---
title: "CF 103729H - Hamster và phép nhân"
...
[CF 103729H - Hamster và phép nhân](https://codeforces.com/problemset/problem/103729/H) 
...
Cho phép$\tau$là một bảng phụ của$g$. Lập bảng phụ tương ứng$\tau'$của$f$thu được bằng cách giải thích cùng một hạn chế đối với các biến và sau đó thay thế$x_{k+1}=x_k$. Bản đồ$\tau \mapsto \tau'$có tính tiêm truyền vào các bảng phụ, vì các phép gán riêng biệt cho$(x_1,\dots,x_i)$vì$g$tạo ra các nhiệm vụ riêng biệt cho$f$trước khi thay thế và bình đẳng sau khi thay thế sẽ bao hàm sự bình đẳng của các hạn chế ban đầu. 
